...
var Timeline = function () {
    function Timeline(timelineString, options) {
    ...
    _createClass(Timeline, [{
        ...
        key: "_parseTimelineString",
        value: function _parseTimelineString(timelineString) {
            var lines = timelineString.split("\n");
            ...
            return lines.map(function (l) {
                return new _TimelineEvent2.default(l);
            });
        }
    }]);
...
var ORIGINAL_DATESTRING = Symbol();
var FROM = Symbol();
var TO = Symbol();
var TEXT = Symbol();

var TimelineEvent = function () {
    function TimelineEvent(eventString) {
        _classCallCheck(this, TimelineEvent);

        var colonIndex = eventString.indexOf(":");
        if (colonIndex === -1) {
            throw new Error("Error parsing '" + eventString + "': missing separating colon (:)");
        }
        var dateString = eventString.substring(0, colonIndex).trim();
    ...
    _createClass(TimelineEvent, [{
        ...
        key: "isInstant",
        value: function isInstant() {
            return this[TO] === undefined;
        }
    }, {
        key: "dayRange",
        value: function dayRange() {
            if (this.isInstant()) {
                return 1;
            }
        ...
        value: function _parseDateString(dateString) {
            var _dateString$split = dateString.split("-"),
                _dateString$split2 = _slicedToArray(_dateString$split, 2),
                unparsedFrom = _dateString$split2[0],
                unparsedTo = _dateString$split2[1];
...
var CollapsibleTextView = function () {
    function CollapsibleTextView(domParent, text) {
        _classCallCheck(this, CollapsibleTextView);
    ...
    _createClass(CollapsibleTextView, [{
        key: "getText",
        ...
        key: "_createTextArea",
        value: function _createTextArea(text) {
...
exports.default = CollapsibleTextView;
...
var TIMELINE_CONTAINER = Symbol();
var TIMELINE_DOM = Symbol();
var TIMELINE = Symbol();
var OPTIONS = Symbol();

var TimelineView = function () {
    function TimelineView(domParent, timelineString, options) {
        ...
        this[TIMELINE] = new _Timeline2.default(timelineString, options);
        this[TIMELINE_CONTAINER].appendChild(this[TIMELINE_DOM]);
        var container = this[TIMELINE_DOM];
        ...
        for (var y = this.startYear; y <= this[TIMELINE].maxYear() + 5; y++) {
            var box = new _YearBox2.default(y, col, options);
            col++;
            container.appendChild(box.dom());
        }

        var totalWidth = options.width;
        var dayWidth = options.columnWidth / 365;
        var startDate = Date.parse("" + this.startYear);
        ...
        try {
            for (var _iterator = this[TIMELINE].events()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                var ev = _step.value;

                var timeDiff = ev.start().getTime() - startDate.getTime();
                var dayDiff = timeDiff / 1000 / 3600 / 24;
                var range = 10;
                if (!ev.isInstant()) {
                    range = Math.max(range, ev.dayRange() * dayWidth);
                }
                var er = new _EventRow2.default(ev, row, dayDiff * dayWidth, range, options);
    ...
    _createClass(TimelineView, [{
        key: "_installTimeline",
        value: function _installTimeline() {}
    }, {
        key: "_containerWithOptions",
        value: function _containerWithOptions(options) {
...
var colFolder = gui.addFolder("Colors");
...
var textArea = new _CollapsibleTextView2.default(document.getElementById("left"), timeline);

function reDraw() {
    v = new _TimelineView2.default(document.getElementById("viz"), textArea.getText(), options);
}

var t = new _Timeline2.default(timeline, options);
console.log(t, t.minYear(), t.maxYear());

var v = new _TimelineView2.default(document.getElementById("viz"), timeline, options);
...
var DOM = Symbol();
var EVENT = Symbol();
var linkRegex = /\[([\w\s\d\.]+)\]\((https?:\/\/[\w\d./?=#]+)\)/g;

var EventRow = function () {
    function EventRow(event, row, leftPad, range, options) {
    ...
    _createClass(EventRow, [{
        ...
        key: "_createRangeView",
        value: function _createRangeView(range, options) {
        ...
        key: "_createDateText",
        value: function _createDateText(options) {
        ...
        key: "_createEventText",
        value: function _createEventText() {
            var r = document.createElement("span");
            var txt = this[EVENT].text();

            r.innerHTML = txt.replace(linkRegex, function (substring, linkText, link) {
...
var YearBox = function () {
    function YearBox(year, column, options) {
        _classCallCheck(this, YearBox);
    ...
    _createClass(YearBox, [{
        ...
        key: "_createTitle",
        value: function _createTitle(year, options) {
